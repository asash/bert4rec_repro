...
from aprec.recommenders.dnn_sequential_recommender.models.albert4rec.albert4rec import (
    ALBERT4Rec,
)
...
def bert4rec(
    ...
    recommender = DNNSequentialRecommender(
        ...
        sequence_splitter=lambda: ItemsMasking(
            masking_prob=masking_prob, recency_importance=rss
        ),
...
recommenders = {
    "ALBERT4Rec": lambda: bert4rec(
        False, 200, arch=ALBERT4Rec, layers=2, masking_prob=0.2
    ),
}
