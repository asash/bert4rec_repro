...
class TestMixer(unittest.TestCase):
    def test_mixer_recommender(self):
        from aprec.datasets.movielens20m import (
            get_movielens20m_actions,
            get_movies_catalog,
        )
        ...
        from aprec.recommenders.dnn_sequential_recommender.models.mixer import (
            MixerModel,
            RecsysMixer,
        )
        ...
        recommender = DNNSequentialRecommender(
            ...
            sequence_splitter=lambda: ItemsMasking(
                recency_importance=exponential_importance(0.8)
            ),
