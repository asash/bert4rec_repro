...
REFERENCE_COLD_START = [
    ("318", 0.6019900660660039),
    ("296", 0.5928136146373703),
    ("356", 0.5671645460239426),
    ("593", 0.494680602882191),
    ("50", 0.46695169879496523),
    ("47", 0.46184204110408533),
    ("527", 0.4398795906398074),
    ("260", 0.43692734916941883),
    ("1", 0.4210339121252358),
    ("589", 0.4195799728444275),
]

REFERENCE_USER_RECOMMENDATIONS = [
    ("296", 0.5097028006608604),
...
class TestSvdRecommender(unittest.TestCase):
    ...
    def test_svd_recommender(self):
        ...
        self.compare_recommendations(
            recommender.recommend(12341324, 10), REFERENCE_COLD_START
        )
