...
class TestRecboleBert4rec(unittest.TestCase):
    def test_sampled_rankings(self):
        ...
        from aprec.recommenders.bert4recrepro.recbole_bert4rec import (
            RecboleBERT4RecRecommender,
        )
        from aprec.recommenders.filter_seen_recommender import FilterSeenRecommender
        from aprec.utils.generator_limit import generator_limit

        recommender = FilterSeenRecommender(
            RecboleBERT4RecRecommender(epochs=5, max_sequence_len=10)
        )
